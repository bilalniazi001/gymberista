...
// ✅ Fixed DashboardStats Component
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 h-full">
      ...
      <div className="text-center mt-4">
        <Link href="/orders" className="text-teal-600 hover:text-teal-800 text-sm font-medium flex items-center justify-center">
...
const ProductStock = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 h-full">
      ...
      <div className="text-center mt-4">
        <Link href="/products" className="text-teal-600 hover:text-teal-800 text-sm font-medium flex items-center justify-center">
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Recent Orders and Stock Status */}
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link 
            href="/products" 
            className="bg-[#629D23] text-white p-4 rounded-lg hover:bg-[#2D3B29] transition duration-300 text-center font-semibold"
          >
            Manage Products
          </Link>
          <span 
